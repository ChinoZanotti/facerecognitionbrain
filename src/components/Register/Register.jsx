...
export default function Register ({ onRouteChange }) {
    return(
        <div className='center'>
            <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center bg-glass">
            <main className="pa4 black-80">
                <div className="measure">
                    <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
                    <legend className="f2 center fw6 ph0 mh0 tc">Register</legend>
                    <div className="mt3">
                    ...
                    <a href="#0" onClick={() => onRouteChange('signin')} className="f6 link dim black db tc pointer">Back</a>
                    </div>
                </div>
            </main>
            </article>
